...
<!--user id for the reviewer and user for the photo uploader-->  
 ...
 <?php
    ...
    foreach($reviewResult as $q)
    {
        ...
        $spotReviewId[$q['SPOT_NAME']]['id'] = $q['SPOT_ID'];
        $i++;
...
<div class="row">
    <div class="box">
        <div class="col-lg-12">
            ...
            <hr>
            <div id = <?php echo "carousel-review-".$spot; ?> class = "carousel slide">
                <!-- Wrapper for slides -->
                ...
                <!-- Controls -->
                <a class="left carousel-control" href= <?php echo "#carousel-review-".$spot; ?> data-slide="prev">
                    <span class="icon-prev"></span>
                </a>
                <a class="right carousel-control" href= <?php echo "#carousel-review-".$spot; ?> data-slide="next">
